    ...
    <div class="admin-sidebar am-offcanvas  am-padding-0" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            ...
            <ul class="am-list admin-sidebar-list">
                <li><a href="<?=\yii\helpers\Url::to(['/admin/home/index'])?>"><span class="am-icon-home"></span> 首页</a></li>
                <li class="admin-parent">
                    ...
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav1">
                        ...
                        <li><a href="<?= \yii\helpers\Url::to(['/admin/user/index'])?>">用户表</a></li>
                    </ul>
                </li>
                <li class="admin-parent">
                    <a class="am-cf" data-am-collapse="{t6arget: '#collapse-nav5'}"><span class="am-icon-file"></span> 表单 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
